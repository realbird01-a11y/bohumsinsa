            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h2 className="font-bold text-gray-900 group-hover:text-[#1B2A4A] transition-colors">
                    {ch.name}
                  </h2>
                  <span
                    className="text-xs font-medium px-2 py-0.5 rounded-full"
                    style={{
                      backgroundColor: ch.badge === 'B2C' ? '#EFF6FF' : '#FFF7ED',
                      color: ch.badge === 'B2C' ? '#1D4ED8' : '#C2410C',
                    }}
                  >
                    {ch.badge}
                  </span>
